...
namespace backend.Data.Migrations
{
    ...
    [Migration("20260923212632_UpdatePhotoColumnLength")]
    partial class UpdatePhotoColumnLength
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("backend.Entities.AttributeDefinition", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("backend.Entities.AttributeOption", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("backend.Entities.Cv", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("backend.Entities.CvLike", b =>
                {
            ...
            modelBuilder.Entity("backend.Entities.DiscussionPost", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("backend.Entities.ExternalAuthTicket", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("backend.Entities.PositionAccessRule", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("backend.Entities.PositionAttribute", b =>
                {
                    b.Property<Guid>("PositionId")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("backend.Entities.PositionProjectTag", b =>
                {
                    b.Property<Guid>("PositionId")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("backend.Entities.UserAttributeValue", b =>
                {
                    b.Property<Guid>("UserId")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("backend.Entities.AttributeOption", b =>
                {
                    b.HasOne("backend.Entities.AttributeDefinition", "Attribute")
                        .WithMany("Options")
            ...
            modelBuilder.Entity("backend.Entities.Cv", b =>
                {
                    b.HasOne("backend.Entities.AppUser", "Candidate")
                        .WithMany("Cvs")
            ...
            modelBuilder.Entity("backend.Entities.CvLike", b =>
                {
                    b.HasOne("backend.Entities.Cv", "Cv")
                        .WithMany("Likes")
                        .HasForeignKey("CvId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("backend.Entities.AppUser", "Recruiter")
                        .WithMany()
            ...
            modelBuilder.Entity("backend.Entities.UserAttributeValue", b =>
                {
                    ...
                    b.HasOne("backend.Entities.AttributeOption", "SelectedOption")
                        .WithMany()
