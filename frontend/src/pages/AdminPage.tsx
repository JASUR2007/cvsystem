    ...
    <div className="admin-layout">
      ...
      <aside className="admin-sidebar">
        ...
        <nav className="admin-nav-menu">
          ...
          <a href="/positions" className="admin-nav-link" title={t('Positions')}>
            <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
          ...
          <a href="/attributes" className="admin-nav-link" title={t('Attributes')}>
            <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
          ...
          <div>
            ...
            <div className="admin-users-toolbar">
              ...
              <div className="admin-toolbar-actions">
                <button
                  type="button"
                  className="btn btn-admin-block btn-sm d-inline-flex align-items-center gap-1"
                ...
                >
                  ...
                  <span className="btn-responsive-text">{t('Block')}</span>
                </button>
                <button
                  type="button"
                ...
                >
                  ...
                  <span className="btn-responsive-text">{t('Unblock')}</span>
                </button>
                <button
                  type="button"
                ...
                >
                  ...
                  <span className="btn-responsive-text">{t('Delete')}</span>
                </button>
              </div>
            </div>
