    ...
    <div className="profile-settings-card">
      <div className="profile-card-header">
        ...
        <div className="d-flex gap-2">
          ...
          {selected.length > 0 && (
            <button className="btn btn-outline-danger btn-sm d-inline-flex align-items-center gap-1" title={t('Delete')} onClick={remove}>
              <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
          ...
          <button className="btn btn-primary btn-sm d-inline-flex align-items-center gap-1" title={t('Add project')} onClick={() => setForm(blank)}>
            <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
              <line x1="12" y1="5" x2="12" y2="19" />
              <line x1="5" y1="12" x2="19" y2="12" />
            </svg>
            <span className="btn-responsive-text">{t('Add project')}</span>
          </button>
        </div>
      </div>
      ...
      {form && (
        ...
        >
          ...
          >
            <form className="modal-content shadow-lg border-0" onSubmit={save}>
